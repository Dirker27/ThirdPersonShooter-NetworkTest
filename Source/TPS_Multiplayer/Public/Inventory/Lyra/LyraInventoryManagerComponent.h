...
public:
	...
	{
		return true; //return FFastArraySerializer::FastArrayDeltaSerialize<FLyraInventoryEntry, FLyraInventoryList>(Entries, DeltaParms, *this);
	}
...
class TPS_MULTIPLAYER_API ULyraInventoryManagerComponent : public UActorComponent
{
	GENERATED_BODY()
